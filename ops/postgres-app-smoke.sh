...
probe "http://127.0.0.1:${HOST_PORT}/api/summary?token=${ADMIN_TOKEN}"
probe "http://127.0.0.1:${HOST_PORT}/api/saved-queries?token=${READ_TOKEN}"
probe "http://127.0.0.1:${HOST_PORT}/api/listings/resolver-status?token=${ADMIN_TOKEN}&listingIds="
probe "http://127.0.0.1:${HOST_PORT}/api/resolve-queue?token=${ADMIN_TOKEN}"
probe "http://127.0.0.1:${HOST_PORT}/api/backlog?token=${ADMIN_TOKEN}&limit=1"
probe "http://127.0.0.1:${HOST_PORT}/api/purchase-history-match-queue?token=${ADMIN_TOKEN}&limit=1"
probe "http://127.0.0.1:${HOST_PORT}/api/purchase-history-match-queue/matches?token=${ADMIN_TOKEN}&limit=1"
