...
function appRuntimeFiles(containerName, runner = spawnSync) {
  ...
  const files = [
    ...
    '/app/scripts/marketplace-workflow-events-postgres-store.js',
    '/app/scripts/marketplace-event-registry-postgres-store.js',
    ...
    '/app/scripts/marketplace-search-keywords-postgres-store.js',
    '/app/scripts/marketplace-maintenance-postgres-store.js',
    '/app/scripts/marketplace-postgres-runtime.js',
