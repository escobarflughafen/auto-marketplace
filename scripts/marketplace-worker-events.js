...
const EVENT_DEFINITIONS = Object.freeze([
  freezeDefinition({
    ...
    workerTypes: [WORKER_TYPES.COLLECTOR, WORKER_TYPES.RESOLVER, WORKER_TYPES.BACKLOG_INDEXER],
    requiredPayloadKeys: ['workerType', 'strategy'],
    optionalPayloadKeys: ['mode', 'args', 'profileId', 'profileDir'],
  }),
  freezeDefinition({
    ...
    workerTypes: [WORKER_TYPES.COLLECTOR, WORKER_TYPES.RESOLVER, WORKER_TYPES.BACKLOG_INDEXER],
    requiredPayloadKeys: ['workerType', 'strategy'],
    optionalPayloadKeys: ['activeListingId', 'activeCommandId', 'profileId', 'leaseExpiresAt', 'processedCount'],
  }),
  freezeDefinition({
    ...
    optionalPayloadKeys: ['reason', 'jitterMultiplier'],
  }),
  freezeDefinition({
